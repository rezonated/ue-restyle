...
public:
	UWireRestyleSettings() { SetDefaults(); };

	static const UWireRestyleSettings* Get() { return GetDefault<UWireRestyleSettings>(); }

	static UWireRestyleSettings* GetM() { return GetMutableDefault<UWireRestyleSettings>(); }
	void SetDefaults();
...
#pragma region Properties
	...
	UPROPERTY(Config, EditAnywhere, Category = "WireRestyleSettings|Hover", DisplayName = "Thickness Multiplier",
		meta = (ClampMin = "1.0", ClampMax = "4.0"))
	float HoverThicknessMultiplier;
	// Time in seconds before the fading starts to occur
	UPROPERTY(Config, EditAnywhere, Category = "WireRestyleSettings|Hover", DisplayName = "FadeInBias",
		meta = (ClampMin = "0.0", ClampMax = "4.0"))
	float HoverFadeInBias;
	// Time in seconds after the bias before the fade is fully complete
	UPROPERTY(Config, EditAnywhere, Category = "WireRestyleSettings|Hover", DisplayName = "FadeInPeriod",
		meta = (ClampMin = "0.0", ClampMax = "4.0"))
	float HoverFadeInPeriod;
	// Determines how lightened color blends (0 = no color applied, 1 = full color applied)
	UPROPERTY(Config, EditAnywhere, Category = "WireRestyleSettings|Hover", DisplayName = "LightFraction",
		meta = (ClampMin = "0.0", ClampMax = "1.0"))
	float HoverLightFraction;
	// Determines how darkened color blends (0 = no color applied, 1 = full color applied)
	UPROPERTY(Config, EditAnywhere, Category = "WireRestyleSettings|Hover", DisplayName = "DarkFraction",
		meta = (ClampMin = "0.0", ClampMax = "1.0"))
